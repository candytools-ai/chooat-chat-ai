        ...
        <header className="sticky top-0 z-40 flex-none mx-auto w-full border-b border-gray-50/0 transition-[opacity] ease-in-out">
            ...
            >
                ...
                <NavigationMenu className="hidden md:block mx-auto">
                    <NavigationMenuList>
                        {navigation.map(({ href, title, badge, children }: any, idx) => (
                            <NavigationMenuItem
                                key={"nav_" + idx}
                                className="px-4 py-3"
                            >
                                {children ? (
                                    ...
                                    <NavigationMenuLink asChild>
                                        ...
                                        >
                                            {title}
                                            {badge && <div className='absolute inline-flex items-center justify-center py-0.5 px-1.5 text-xs font-normal text-white bg-red-500 border-2 border-white rounded-full -top-5 -right-6'>{badge}</div>}
                                        </a>
                                    </NavigationMenuLink>
                                )}
                            </NavigationMenuItem>
